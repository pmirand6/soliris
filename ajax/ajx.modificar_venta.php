 ...
 * fecha_mod_venta: (TimeStamp - Fecha de la modificacion de la venta)
...
if (isset($_POST["oper"]) && $_POST["oper"] == 'modificar_venta') {
    ...
    $SQL = "CALL `ST_MODIFICAR_VENTA`('$idVenta',
     '$idMedico', 
     '$idProducto', 
     '$idPresentacion', 
     '$cantUnidades', 
    ...
    if (is_bool($response)) {
        ...
        if ($flagUpDoc) {
            ...
            $resp = array(
                ...
                'icon' => 'success',
                'text' => 'Se modificó el registro de venta: ' . $idVenta,
            );
