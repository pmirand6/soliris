<?php
    ...
    $SQL = "
    SELECT
      C.id as id, C.canal as canal, C.familia as familia, C.direccion as direccion, C.mail as mail, C.dir_tec as dir_tec, C.cont_venta as cont_venta, C.cont_otro as cont_otro, C.puntos_entrega as puntos_entrega,
      C.estado as estado, (SELECT GROUP_CONCAT(RD.documento) FROM soliris_documentacion as RD where RD.referencia = 'canales' AND RD.id_maestro = C.id ORDER BY RD.id desc LIMIT 1) as documentos
    FROM
      canales as C
