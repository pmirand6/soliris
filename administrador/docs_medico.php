          ...
          <!--  <div class="form-group">
                ...
                <div class="col-sm-4 col-xs-6">
                    <div class="input-group">
                        ...
                        <input id="fecha" name="fecha" type="text" placeholder="Fecha de Capacitación..." class="form-control input-md date"
                               maxlength="12">
                    </div>
                </div>
            </div>
-->
            ...
            if(isset($_GET["id"]) AND !empty($_GET["id"])) {
                ...
                <div class="form-group text-center">
                    <div class="col-sm-12">
                        <a id="save" name="save" class="btn btn-success">
...
<?php
    ...
    echo "No seleccionó un paciente al cuál adjuntar documentación.";
}
?>
