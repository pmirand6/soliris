...
<body>
    <form class="form-horizontal col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 form">
        <fieldset class="form-horizontal col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10">
            <!-- Form Name -->
            <legend>Datos de la Patología</legend>
            <?php 
            if (isset($id) AND $id != "") {
                ?>
                <!-- ID -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5 col-xs-8 selectContainer">
                    <div class="input-group">
                        <div class="input-group-addon"><span id="icon_estado" class="fa fa-heartbeat"></span></div>
...
?>
    <!-- Custom JS -->
    <script type="text/javascript" src="../resources/JS/Develop/patologia.js"></script>
