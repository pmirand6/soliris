...
<head>
    ...
    <title>Historial de Documentación Paciente</title>
...
<body>
    <div>
        <i id="Docs" class="fa fa-step-backward btn btn-xs btn-default" title="Volver"
               style="cursor:pointer;margin-left: 10%;margin-top: 2%;"></i>
    </div>
...
?>
         <legend class="text-center"><u>Historial de Documentación del Paciente</u><br><b><?php echo $nombre_paciente;?></b></legend>
...
<?php
    ...
    $SQL = "SELECT * FROM soliris_documentacion as RD 
                WHERE RD.referencia = 'pacientes'
                AND RD.id_maestro = '$id' 
                ORDER BY id DESC;";
...
?>
    <!-- Custom JS -->
    <script type="text/javascript" src="../resources/JS/Develop/docs_hist_paciente.js"></script>
