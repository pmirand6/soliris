...
if(isset($_GET["id"])){
    $id = $_GET["id"];
    $SQL = "SELECT * FROM auxiliar WHERE tipo = 'unidades' AND id = '$id'";
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 col-xs-8">
                    <div class="input-group">
                        ...
                        <input id="nombre" name="nombre" type="text" placeholder="Cantidad Numerica" class="form-control input-md" maxlength="45" required="" value="<?php echo $nombre?>">
                    </div>
                </div>
            </div>
...
?>
    <!-- Custom JS -->
    <script src="../resources/JS/Develop/a_unidad.js"></script>
        <!-- <script type="text/javascript" src="../resources/JS/a_unidad.min.js"></script> -->
</body>
</html>
