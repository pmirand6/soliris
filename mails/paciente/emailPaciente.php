									...
									<tr>
										<td style="padding-left:10px;padding-right:10px;padding-bottom:20px">
											...
											<table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF" width="100%" class="columnFull">
												...
												<tr>
													<td align="center" valign="top" style="padding-bottom:30px;padding-left:20px;padding-right:20px;padding-top:25px;" class="postTitle">
														<!-- Title Text // -->
														<h1 class="bigText" style="color:#513939; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:20px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:32px; text-align:center; text-transform:none; padding:0; margin:0;">
															{{accion}}
														</h1>
													</td>
												</tr>
														...
														<table align="center" border="0" cellpadding="0" cellspacing="0">
															<tr>
																<td align="center" class="postButton" style="background-color:#191919;padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px">
																	<!-- Post Button Link // -->
																	<a href="{{url}}" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; font-style:normal; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; padding:0; margin:0; display:block;" >
																		Ver Paciente
																	</a>
																</td>
															</tr>
