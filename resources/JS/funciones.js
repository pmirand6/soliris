...
function wait(e) {
    for (var n = (new Date).getTime(), t = n; n + e > t;) t = (new Date).getTime()
}
...
function docs_icon(e) {
    if (-1 == e.indexOf("Sin Documentación")) {
        var n = aplicacion + "/documentacion/" + e,
            ...
            s = '<a href="' + n + '" target="_blank"><li class="btn btn-default" style="cursor:pointer;" title="' + o + '"><span class="' + c + '" style="cursor:pointer;")"></span></li>';
        return s
    }
...
function estado_icon(e) {
    var n = "TBL TBL-" + e;
    return '<samp class="' + n + '" title="' + e + '"><p class="hidden ">' + e + "</p></samp>"
}

function sexo_icon(e) {
    var n = "TBL TBL-" + e;
    return '<div class="' + n + '" title="' + e + '"><p class="hidden">' + e + "</p></div>"
}
