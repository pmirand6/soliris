...
function cerrarVentaMod(idPac, idVenta, idEstado) {
  $.post(
    aplicacion + "/ajax/ajx.control_modificacion_venta.php",
    { oper: "deleteControlModicacionVenta", idPac: idPac, idVenta: idVenta, idEstado: idEstado },
