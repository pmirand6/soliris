...
//            { "mData": "cgestar", "bSearchable": true, "sWidth": "3%", "sClass": "center"},
            ...
            { "mData": "subPatologia", "bSearchable": true, "sWidth": "20%", "sClass": "center"},
			...
			{ "mData": "sub-estado", "bSearchable": true, "sWidth": "3%", "sClass": "center"},
...
function callPac(id, grupo){
    $('#win').window('open');  // close a window
    $('#win_pac').attr('src', aplicacion + '/administrador/paciente.php?id=' + id);
