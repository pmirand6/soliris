      ...
      .on("success.form.fv", function(e) {
        ...
        $("#PacDat").DataTable({
          ...
          ajax: {
            ...
            "dataSrc": "",
            data: { id: idPac, oper: "showPaciente" }
          },
          
          columns: [
            { data: "nombre_completo" }, // 0
            { data: "sexo" }, // 1
            { data: "fecha_nac_formateada"}, // 2
            { data: "fecha_nac_formateada" }, // 3
            { data: "patologiaNombre" }, // 4
            { data: "subPatologiaNombre" }, // 5
            { data: "fecha_con" }, // 6
            { data: "estado_valor" }, // 7
            { data: "sub_estado_valor" } // 8
          ],
          columnDefs: [
            {
        ...
        $("#UltVenTB").dataTable({
          ajax: {
            url: aplicacion + "/ajax/ajx.informes_ult_vent.php?id=" + idPac,
            dataSrc: "data"
          },
          ordering: false,
          destroy: true,
