...
//echo basename($_SERVER['SCRIPT_FILENAME']);
    ...
    //$db = mysqli_connect('127.0.0.1','admin','') or die ("Database error"); // conector desarrollo local
    

    $servidor =_URL_SERVIDOR;
    $usuarioBd = _USUARIO_BD;
    $passwordBd = _PASSWORD_BD;

    $db = mysqli_connect($servidor,$usuarioBd,$passwordBd) or die ("Database error");
