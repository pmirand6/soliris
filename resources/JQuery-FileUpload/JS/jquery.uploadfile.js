...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        $.getScript(aplicacion + "/resources/JQuery-FileUpload/JS/jquery.form.min.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            extErrorStr: "no esta permitido este archivo. Las extensiones de archivo deben ser: ",
            sizeErrorStr: "no esta permitido. El peso máximo del archivo es: ",
