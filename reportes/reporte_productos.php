...
<head>
    ...
    <style type="text/css">
        ...
        /* Custom CSS */
        @import "../resources/CSS/Develop/reporte_productos.css";
    </style>
</head>
<body>
    ...
    <!-- Custom JS -->
    <script src="../resources/JS/Develop/reporte_productos.js"></script>
    <!--    <script src="../resources/JS/reporte_productos.min.js"></script>-->
</body>
</html>
