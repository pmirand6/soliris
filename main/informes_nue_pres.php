            ...
            <fieldset>
                ...
                <div class="form-group col-sm-12 col-xs-12">
                    ...
                    <div class="col-sm-6 col-xs-6">
                        <!-- Sub Patologia -->
                        <div class="form-group">
                            <label class="col-sm-4 col-xs-4 control-label" for="patologia">Sub Patología </label>
                            <div class="col-sm-6 col-xs-6 selectContainer">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-heartbeat"></span></div>
                                </div>
                ...
                <div class="form-group col-sm-12 col-xs-12">
                    <div class="col-sm-8 col-xs-8">
                        <!-- Médico -->
                        <div class="form-group">
                            <label class="col-sm-6 col-xs-6 control-label" for="medico">Médico </label>
                            <div class="col-sm-6 col-xs-6">
                                <div class="input-group">
                    ...
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-xs-6 selectContainer">
                                <div class="input-group">
                                    ...
                                    <input id="inst" name="institucion" type="text" autocomplete="off" placeholder="Tipee el Nombre Institución" class="form-control input-md" maxlength="100" required="" i_id="" value="<?php if (isset($last_institucion) and !empty($last_institucion)) {
                                                                                                                                                                                                                                echo $last_institucion;
                                                                                                                                                                                                                            } ?>">
                       ...
                       <?php
                        ...
                        ?>
                                ...
                                <input type="" id="id_institucion" name="id_institucion" style="display: none;" value="<?php if (isset($inst_id) and !empty($inst_id)) {
                                                                                                                            echo $inst_id;
                                                                                                                        } ?>">
                            </div>
                        </div>
